...
event zeek_init()
	...
	event ssl_client_hello(dummy, 769, 769, network_time(), "\x8a\x9b}2^\xd9\x08\xde\x8c\xb2\xb4\xdeP\xec\x88\x18J\x1fn\xc7#\xc1\xd5\xa3D\xa6\xcc4", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(47, 53, 5, 10, 49171, 49172, 49161, 49162, 50, 56, 19, 4),
	    vector(0));
	...
	event ssl_extension(dummy, T, 10, "\x00\x04\x00\x17\x00\x18");
	event ssl_extension(dummy, T, 11, "\x01\x00");
	event ssl_client_hello(dummy, 769, 769, network_time(), "\xcd+\xe6\xed\xe8]\xef\x1e?\xcd\x80\xdd\xfc\x00\x9a\xbb\x89\xf5\xb9\x1f\xb9\xc99q\xb3m\x99\x09", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(47, 53, 5, 10, 49171, 49172, 49161, 49162, 50, 56, 19, 4),
	    vector(0));
	event my_finalize_ssl(dummy);
	}
