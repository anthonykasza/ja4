...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=8,
	    $SignatureAlgorithm=4 ], [ $HashAlgorithm=4, $SignatureAlgorithm=3
	    ], [ $HashAlgorithm=4, $SignatureAlgorithm=1 ], [ $HashAlgorithm=2,
	...
	event ssl_client_hello(dummy, 771, 771, network_time(), "\xfe\x1b\x95\xc74\x83\x93i\x1bt@H\xf5\x14\xed~\xc2\x10f\xcd\xecT\\xd5^p7\xe6", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4865, 4866, 4867), vector(0));
