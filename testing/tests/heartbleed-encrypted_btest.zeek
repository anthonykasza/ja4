...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=4,
	    ...
	    ], [ $HashAlgorithm=2, $SignatureAlgorithm=1 ], [ $HashAlgorithm=2,
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\xc8M\x90\x15~\xc3\xb0i\x83Ke\xfa\x96\x84\xb9\xa6\xf3z\xe5Q\"\xd6:\xe7\x10\xe8\xf0\x0f", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(49199, 49195, 49169, 49159, 49171, 49161, 49172, 49162, 5, 47, 53,
	    49170, 10), vector(0));
