...
event zeek_init()
	...
	event ssl_extension_key_share(dummy, T, vector(29, 23, 24));
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=4,
	    ...
	    ], [ $HashAlgorithm=6, $SignatureAlgorithm=3 ], [ $HashAlgorithm=2,
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=8, $SignatureAlgorithm=4
	    ], [ $HashAlgorithm=8, $SignatureAlgorithm=5 ], [ $HashAlgorithm=8,
	    $SignatureAlgorithm=6 ], [ $HashAlgorithm=4, $SignatureAlgorithm=1
	    ], [ $HashAlgorithm=5, $SignatureAlgorithm=1 ], [ $HashAlgorithm=6,
	    $SignatureAlgorithm=1 ], [ $HashAlgorithm=2, $SignatureAlgorithm=1
	    ], [ $HashAlgorithm=4, $SignatureAlgorithm=2 ], [ $HashAlgorithm=5,
	    $SignatureAlgorithm=2 ], [ $HashAlgorithm=6, $SignatureAlgorithm=2
	    ], [ $HashAlgorithm=2, $SignatureAlgorithm=2 ]));
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\x06\xd0\xe8\xc6\x89\xcdR\x10P\xf7l\xd5\xd2x\x12\xd6\xbe\xca\x13C79\x13\xc0L\x13x!", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4865, 4867, 4866, 49195, 49199, 52393, 52392, 49196, 49200,
	    49162, 49161, 49171, 49172, 51, 57, 47, 53, 10), vector(0));
	...
	event ssl_extension(dummy, T, 13, "\x00\x1e\x04\x03\x05\x03\x06\x03\x02\x03\x08\x04\x08\x05\x08\x06\x04\x01\x05\x01\x06\x01\x02\x01\x04\x02\x05\x02\x06\x02\x02\x02");
	event ssl_extension(dummy, T, 21, "");
	event ssl_client_hello(dummy, 771, 769, network_time(), "VQH\xac\x11\x9c\xd3\xce\xdc\xcb\x12\xe5(\xd1\xcfF\x88\x0d\x8d\xee\xf9/\xe9\x10:\xe6\x15\x1a", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4865, 4867, 4866, 49195, 49199, 52393, 52392, 49196, 49200,
	    49162, 49161, 49171, 49172, 51, 57, 47, 53, 10), vector(0));
	event my_finalize_ssl(dummy);
	}
