...
event zeek_init()
	...
	event ssl_client_hello(dummy, 771, 771, network_time(), "\xf5\xbc\xac\xc5\x96\x0c\xc2\xea~s\xdb\xf6\xc1O\xb3\xd7,\x84\x88\x8e`\xed\xee\W?\xc2\xe6", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4865, 4867, 4866), vector(0));
