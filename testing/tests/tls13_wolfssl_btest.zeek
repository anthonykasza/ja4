...
event zeek_init()
	...
	event ssl_extension(dummy, T, 10,
	    "\x00\x0e\x00\x19\x00\x18\x00\x17\x00\x15\x00\x13\x00\x10\x01\x00");
	event ssl_extension(dummy, T, 23, "");
	event ssl_client_hello(dummy, 771, 771, network_time(), "\x93\x98S\xf7K\xb0\x84\xd6\xf5NnE\x0b\x98\x0b\xf9j1\x19\xf4\xbd[\xc8\xab\x82\xecV ", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4866), vector(0));
