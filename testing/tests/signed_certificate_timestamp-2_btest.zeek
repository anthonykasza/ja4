...
event zeek_init()
	...
	event ssl_extension_key_share(dummy, T, vector(51914, 29));
	...
	event ssl_extension_supported_versions(dummy, T, vector(6682, 32530, 771, 770,
	    769));
	event ssl_extension(dummy, T, 43,
	    "\x0a\x1a\x1a\x7f\x12\x03\x03\x03\x02\x03\x01");
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\x1bb\xee:\xa2\x8c\xe7\xd9n\x020\x94\x9e\xd0\xa3(}R[1\\x13\xf3X[\xee\x8d\xe7", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(56026, 4865, 4866, 4867, 49195, 49199, 49196, 49200, 52393,
