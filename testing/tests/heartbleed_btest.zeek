...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=4,
	    ...
	    ], [ $HashAlgorithm=2, $SignatureAlgorithm=1 ], [ $HashAlgorithm=4,
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=5, $SignatureAlgorithm=3
	    ], [ $HashAlgorithm=6, $SignatureAlgorithm=3 ], [ $HashAlgorithm=2,
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=2, $SignatureAlgorithm=2
	    ]));
	...
	event ssl_client_hello(dummy, 771, 771, network_time(), "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4, 5, 10, 13, 16, 19, 22, 47, 48, 49, 50, 51, 53, 54, 55, 56, 57, 60,
	    61, 62, 63, 64, 65, 68, 69, 102, 103, 104, 105, 106, 107, 132, 135,
	    136, 150, 156, 157, 158, 159, 255, 49154, 49155, 49156, 49157,
	    49159, 49160, 49161, 49162, 49164, 49165, 49166, 49167, 49169,
	    49170, 49171, 49172, 49187, 49188, 49191, 49195, 49196, 49199,
	    49201, 49202), vector(0));
