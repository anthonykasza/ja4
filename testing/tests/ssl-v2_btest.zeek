...
event zeek_init()
	...
	event ssl_client_hello(dummy, 2, 0, network_time(),
	    "\x1c0\xe2\xb1/L\x04RTv\xf2\x80\xc0z\xbe\xe5", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(458944, 327808, 196736, 65664, 393280, 262272, 131200),
	    vector());
