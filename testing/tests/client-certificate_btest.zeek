...
event zeek_init()
	...
	event ssl_extension(dummy, T, 10,
	    "\x00\x0c\x00\x1d\x00\x17\x00\x18\x00\x19\x01\x00\x01\x01");
	...
	event ssl_extension_key_share(dummy, T, vector(29, 23));
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\x88\x0a\xeb*h\xe9\xe86\x04\xc4D2\x99t\xa5'\xce\x9b+.3\xe2\xaa\x8e\xd5\xb2s\xbe", "\xbfj\xed\x7f\x07\x11\xfc&\x8ew_\x95\x99]\xa1\xd3l\xe0\x85\xacz\x15@n\xa1\x83-\xbb\x90B\xb5s",
