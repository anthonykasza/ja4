...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=4,
	    ...
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=3, $SignatureAlgorithm=1
	    ], [ $HashAlgorithm=2, $SignatureAlgorithm=1 ], [ $HashAlgorithm=3,
	    $SignatureAlgorithm=2 ], [ $HashAlgorithm=2, $SignatureAlgorithm=2
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "Y\xfd\x97ha\xb6\xdf\xa4I\xb3\x19r\xea\xcb\xba\x98\xbf\xe1u;\xe34\x99\x0fV\x1f!\x8b", "G\x84+\xdf.\x7fx\x99\x8cuC\xfdL\xa8V.<\xe6\xaf\x1e\x89\xa9\x87\xdcV\x9b\xa32\xab\xfd\xdb\x9f",
	    vector(4866, 4867, 4865, 49196, 49200, 159, 52393, 52392, 52394,
	    49195, 49199, 158, 49188, 49192, 107, 49187, 49191, 103, 49162,
	    49172, 57, 49161, 49171, 51, 173, 171, 52398, 52397, 52396, 157,
	    169, 52395, 172, 170, 156, 168, 61, 60, 49208, 49206, 183, 179, 149,
