...
event zeek_init()
	...
	event ssl_client_hello(dummy, 771, 769, network_time(),
	    "\xd1p\xa0H\xa0%\x92Ty\xf1\xa5sa\x08Q\xd3\x0a\x1f>rg\x83i2y}\xef\x95", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(49172, 255), vector(1, 0));
