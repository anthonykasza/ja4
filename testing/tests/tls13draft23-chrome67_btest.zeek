...
event zeek_init()
	...
	event ssl_extension(dummy, T, 0,
	    "\x00\x1b\x00\x00\x18tls13.crypto.mozilla.org");
	...
	event ssl_extension_key_share(dummy, T, vector(39578, 29));
	...
	event ssl_extension_supported_versions(dummy, T, vector(56026, 32535, 771, 770,
	    769));
	event ssl_extension(dummy, T, 43,
	    "\x0a\xda\xda\x7f\x17\x03\x03\x03\x02\x03\x01");
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\x0a\x9c\xd2o}\x89\xb58\xc8=E\x0c`\xc19?\x14WL2i\xaf\x7fm\x10R\xbb\x8f", "\x1f\x9f#\x85\x11\xd3\xac\x9di\xed)\xb1,%\xc5n\x15\x92C\x1a\xda\xb4K9\xf8g\xef\xf6\xca\x99(n",
	    vector(39578, 4865, 4866, 4867, 49195, 49199, 49196, 49200, 52393,
	    52392, 49171, 49172, 156, 157, 47, 53, 10), vector(0));
