...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=6,
	    ...
	    ], [ $HashAlgorithm=4, $SignatureAlgorithm=3 ], [ $HashAlgorithm=2,
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=8, $SignatureAlgorithm=6
	    ], [ $HashAlgorithm=8, $SignatureAlgorithm=11 ], [ $HashAlgorithm=8,
	    $SignatureAlgorithm=5 ], [ $HashAlgorithm=8, $SignatureAlgorithm=10
	    ], [ $HashAlgorithm=8, $SignatureAlgorithm=4 ], [ $HashAlgorithm=8,
	    $SignatureAlgorithm=9 ], [ $HashAlgorithm=6, $SignatureAlgorithm=1
	    ], [ $HashAlgorithm=5, $SignatureAlgorithm=1 ], [ $HashAlgorithm=4,
	    $SignatureAlgorithm=1 ], [ $HashAlgorithm=3, $SignatureAlgorithm=1
	...
	event ssl_extension(dummy, T, 10,
	    "\x00\x0a\x00\x19\x00\x18\x00\x17\x00\x15\x01\x00");
	event ssl_extension(dummy, T, 22, "");
	event ssl_client_hello(dummy, 65277, 65277, network_time(), "\x94\xfb6e\x8f \x88\xe6)\xd2\x92:\xd45\x88$\x16>0\xb8q_R\xb5`\xe6a\xd1", "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	    vector(4865, 4866, 4867, 49196, 49195, 49200, 49199, 159, 158,
