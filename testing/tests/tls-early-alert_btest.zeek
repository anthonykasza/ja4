...
event zeek_init()
	...
	event ssl_extension_signature_algorithm(dummy, T, vector([ $HashAlgorithm=4,
	    ...
	    $SignatureAlgorithm=1 ], [ $HashAlgorithm=4, $SignatureAlgorithm=3
	    ], [ $HashAlgorithm=5, $SignatureAlgorithm=3 ], [ $HashAlgorithm=6,
	    $SignatureAlgorithm=3 ], [ $HashAlgorithm=2, $SignatureAlgorithm=3
	    ], [ $HashAlgorithm=4, $SignatureAlgorithm=2 ], [ $HashAlgorithm=2,
	...
	event ssl_client_hello(dummy, 771, 769, network_time(), "\xbd\xc1P\x1e\xb4\xfa\x8d\xa6\x9a\x90\xf7\x0ff\x92A\xc83:\x17\xe9\xa9\x9b\xeeh\x0cR.\xb1", "M\x1f\xe6\xda\x01\xecw)\xaf \xaaE\x8fG\xb1>\xc8J\x1a\xe4pEe\xfb\x13\x19k\xbf\xe6\xf0\xd2\x87",
	    vector(49195, 49199, 49162, 49161, 49171, 49172, 51, 57, 47, 53,
	    10), vector(0));
